...
describe('ScheduleMultiSelect', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should show loading state when isLoadingInitial is true', () => {
      renderWithProviders(
        <ScheduleMultiSelect {...defaultProps} isLoadingInitial={true} />
      );
    ...
    it('should display selected schedules as chips', () => {
      renderWithProviders(
        <ScheduleMultiSelect {...defaultProps} value={[mockSchedules[0]]} />
      );
  ...
  describe('Option Management', () => {
    it('should merge selected schedules with search results', async () => {
      ...
      renderWithProviders(
        <ScheduleMultiSelect {...defaultProps} value={[selectedSchedule]} />
      );
